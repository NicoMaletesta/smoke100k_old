...
TRAIN = {
    ...
    "checkpoint_dir": r"/home/nicola/Scaricati/checkpointssept",
    "log_dir":        r"/home/nicola/Scaricati/checkpointssept/logs",
    #percorso per fare il resume del training a partire da un modello ( None per partire da zero)
    "resume": r"/home/nicola/Scrivania/segmentation models/smoke/smoke_best.pth",
