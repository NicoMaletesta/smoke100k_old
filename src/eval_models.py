...
if __name__ == '__main__':
    ...
    parser.add_argument('--models_dir', type=str, default=r"/home/nicola/Documenti/8sept", help='Directory containing .pth checkpoint files')
    ...
    parser.add_argument('--out_dir', type=str, default=r"/home/nicola/Documenti/8sept/infer", help='Base output directory (per-checkpoint subfolders will be created)')
    ...
    parser.add_argument('--save_overlay', action='store_true', help='Save RGB overlays')
