...
if __name__ == '__main__':
    ...
    p.add_argument('--model_path', type=str, default=r"/home/nicola/Documenti/smokedetector_2309/smoke_best.pth")
    ...
    p.add_argument('--video_path', type=str, default=r"/home/nicola/Scrivania/test image from the net/Fiorinismoke.mp4")
    p.add_argument('--out_dir', type=str, default=r"/home/nicola/Documenti/smokedetector_2309/infer_prob")
