...
def main():
    ...
    parser.add_argument('--models_dir', type=str, default=r"/home/nicola/Documenti/smokeresults cell/partially_good_smokedetector", help='Directory containing .pth checkpoint files')
    ...
    parser.add_argument('--out_dir', type=str, default=r"/home/nicola/Documenti/smokeresults cell/partially_good_smokedetector/measure_models", help='Base output directory (per-checkpoint subfolders will be created)')
