...
def main():
    ...
    parser.add_argument('--models_dir', type=str, default=r"/home/nicola/Scaricati/checkpointssept22", help='Directory containing .pth checkpoint files')
    ...
    parser.add_argument('--out_dir', type=str, default=r"/home/nicola/Scaricati/checkpointssept22/measure_models", help='Base output directory (per-checkpoint subfolders will be created)')
