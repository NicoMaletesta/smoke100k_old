...
def main():
    ...
    parser.add_argument('--out_dir', type=str, default=r"/home/nicola/Documenti/8sept/measure", help='Base output directory (per-checkpoint subfolders will be created)')
