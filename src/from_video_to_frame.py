...
def main():
    ...
    ap.add_argument("--input", default=r"/home/nicola/Scrivania/test image from the net/wildfirevideo.mp4", help="input video file or input folder")
    ap.add_argument("--output", default=r"/home/nicola/Immagini/test frames", help="output folder to store frames")
